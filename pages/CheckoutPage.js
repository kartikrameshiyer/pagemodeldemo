...
class CheckoutPage {
    constructor(){
        ...
        this.nextShippingBtn = Selector('.button-1.shipping-method-next-step-button')
        this.nextDayOption = Selector("input#shippingoption_1");
        this.nextPaymentBtn = Selector('.button-1.payment-method-next-step-button')
        this.nextConfirmBtn = Selector('.button-1.payment-info-next-step-button')
